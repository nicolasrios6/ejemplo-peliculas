...
namespace ejemplo_peliculas.Controllers
{
    ...
    public class PeliculaController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,Sinopsis,FechaLanzamiento,MinutosDuracion,PosterUrlPortada,GeneroId,PlataformaId")] Pelicula pelicula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,Sinopsis,FechaLanzamiento,MinutosDuracion,PosterUrlPortada,GeneroId,PlataformaId")] Pelicula pelicula)
        {
            if (id != pelicula.Id)
            {
                return NotFound();
